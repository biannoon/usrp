...
<div class="easyui-layout" style="background:#eee;" fit="true">
    <div data-options="region:'center',title:'基本信息'" style="width:40%;">
        <form id="form_sysGroup_insert" method="post">
            <table width="100%">
                <input class="easyui-textbox" type="hidden" id="groupId_insert" name="groupId" value="<%=groupId%>"/></td>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <input class="easyui-textbox" id="blngtoOrgNo_hid" name="blngtoOrgNo" value="" type="hidden"/>
                    </td>
                </tr>
                <tr>
        ...
        <div style="text-align:center">
            <a href="javascript:void(0)" class="easyui-linkbutton" id="but_insert" iconCls="icon-save" plain=true onclick="submitSysGroup('form_sysGroup_insert','<%=basePath%>','sysGroup/insertSysGroup','1')">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" id="but_reset" iconCls="icon-set" plain=true onclick="resetForm('form_sysGroup_insert')">重置</a>
        ...
        <table width="97%">
            <tr>
                <td>
                    ...
                    <div id="menu_add_01">
                        <div onclick="toResourcesPage('win_sysGroup_resource','<%=basePath%>','0','1')">机构</div>
                        <div onclick="toResourcesPage('win_sysGroup_resource','<%=basePath%>','1','1')">子系统</div>
                    </div>
...
<div id="win_sysGroup_resource"></div>
<script type="text/javascript">
    $(function () {
        //-初始化新增详细信息页面
        initSysGroupInsertPage();

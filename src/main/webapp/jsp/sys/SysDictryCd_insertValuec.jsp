...
<form id="form_insert" method="post">
    <table width="100%" style="text-align: center" id = "tab1" cellpadding="5">
        <tr>
            ...
            <td align="left">
                <input type="text" id="dictryId_insert" name="dictryId" value="" required="true" style="width: 200px" maxlength="32" >
            ...
            <td align="left">
                <input id="dictryNm_insert" name="dictryNm"  required="true" value="" style="width: 200px">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" id="pareDictryId_insert" name="pareDictryId"  value="<%=dictryId%>" style="width: 200px" maxlength="32" >
            ...
            <td align="left">
                <input id="blngtoDictryId_insert" name="blngtoDictryId" required="true" value="<%=dictryId%>"  style="width: 200px">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" id="cdTyp_insert" name="cdTyp" value="SYS0102" readonly="true"  style="width: 200px" maxlength="32" >
            ...
            <td align="left" colspan="10">
                <textarea id="dictryComnt_insert" name="dictryComnt" cols="30" rows="3"></textarea>

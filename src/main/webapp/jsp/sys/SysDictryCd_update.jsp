        ...
        <form id="form_sys_dictry_insert" method="post">
            <table width="100%" style="text-align: center"  cellpadding="5">
                <tr>
                    ...
                    <td align="left"><input class="easyui-validatebox" id="dictryId_insert" name="dictryId" data-options="required:true,validTyp:'uniqueDictry'"></td>
                </tr>
                <tr>
                    <td align="right"><span style="font-size: 12px">字典类型名称：</span></td>
                    <td align="left"><input class="easyui-validatebox" id="dictryNm_insert" name="dictryNm" data-options="required:true,validTyp:''"></td>
                </tr>
                <tr>
                    <td align="right"><span style="font-size: 12px">上级字典代码ID：</span></td>
                    <td align="left"><input class="easyui-validatebox" id="pareDictryId_insert" name="pareDictryId" data-options="required:true,validTyp:''"></td>
                </tr>
                <tr>
                    <td align="right"><span style="font-size: 12px">代码类型：</span></td>
                    <td align="left"><input class="easyui-validatebox" id="cdTyp_insert" name="cdTyp" data-options="required:true,validTyp:''"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input class="easyui-textbox" id="blngtoDictryId" name="blngtoDictryId" type="hidden" value="<%=sysDictryCd.getBlngtoDictryId()%>"></td>
                </tr>
            </table>
        </form>
        <div style="text-align:center">
            <a href="javascript:void(0)" class="easyui-linkbutton" plain=true id="btn_add" iconCls="icon-save" onclick="submitSysDictry('form_sys_dictry_insert','dictionary/updateSysDictryCd')">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" plain=true iconCls="icon-remove" onclick="closeWindowBySysDictry('win_sys_dictry')">关闭</a>
        </div>
    </div>
...
<script type="text/javascript">
    //初始化页面
    $(function () {
        initTextboxByDictry('dictryId_insert','<%=sysDictryCd.getDictryId()%>',20,false,'150','20');
        initTextboxByDictry('dictryNm_insert','<%=sysDictryCd.getDictryNm()%>',50,false,'150','20');
        initTextboxByDictry('pareDictryId_insert','<%=sysDictryCd.getPareDictryId()%>',20,true,'150','20');
        initComboboxByDictry('cdTyp_insert','SYS01','<%=sysDictryCd.getCdTyp()%>',true,'150','20');
        initTextboxByDictry('dictryComnt_insert','<%=sysDictryCd.getDictryComnt()%>',200,false,'150','100');
        initSysDictryInsertPage_DG('dg_sys_dictry_insert','<%=sysDictryCd.getBlngtoDictryId()%>');
    })
